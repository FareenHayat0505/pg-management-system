...
const Properties = () => {
  ...
  const [form, setForm] = useState({
    name: '', address: '', city: '',
    totalFloors: '', contactPhone: '', amenities: ''
  });
      ...
      {showForm && (
        <div style={s.formCard}>
          <h3 style={s.formTitle}>
            {editingId ? '✏️ Edit Property' : '+ New Property'}
          </h3>

          {/* Info note */}
          <div style={s.infoNote}>
            ℹ️ After adding a property, go to <strong>Rooms</strong> page to add rooms and beds for this property.
          </div>
  ...
  { key: 'totalFloors',  label: 'Total Floors',               placeholder: 'e.g. 3', type: 'number' },
            ...
            <div className="anim-card" key={p._id} style={s.card}>
              ...
              <div style={s.cardHead}>
                ...
                <div style={s.cardActions}>
                  ...
                  <button style={s.delBtn} onClick={() => handleDelete(p._id)} title="Delete">🗑</button>
                </div>
              </div>
              ...
              <div style={s.stats}>
                {[
                 ...
                 { label: 'Floors',  value: p.totalFloors,   color: '#d97706', bg: '#fffbeb' },
                ].map(stat => (
              ...
              <div style={s.bedStats}>
                <div style={s.bedStatItem}>
                  <span style={s.bedDot('🟢')} />
                  <span style={s.bedStatText}>{p.totalBeds - p.occupiedBeds} beds free</span>
                </div>
                <div style={s.bedStatItem}>
                  <span style={s.bedDot('🔴')} />
                  <span style={s.bedStatText}>{p.occupiedBeds} beds occupied</span>
                </div>
                <div style={s.bedStatItem}>
                  <span style={s.bedDot('⚪')} />
                  <span style={s.bedStatText}>{p.totalBeds} total beds</span>
                </div>
              </div>
              ...
              <div style={s.barBg}>
                <div style={{
                  ...
                  backgroundColor: p.occupancyRate > 80 ? '#ef4444' : p.occupancyRate > 50 ? '#f59e0b' : '#10b981'
                }} />
              </div>
              ...
              <div style={s.cardFoot}>
                ...
                <span style={s.footItem}>🏗️ {p.totalFloors} floors</span>
                <span style={{
                  ...s.statusBadge,
...
const s = {
  ...
  cardHead: { display: 'flex', alignItems: 'flex-start', gap: '12px', marginBottom: '10px' },
  cardIcon: { fontSize: '24px', width: '44px', height: '44px', backgroundColor: '#eff6ff', borderRadius: '10px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 },
  cardHeadInfo: { flex: 1 },
  ...
  editBtn: { width: '32px', height: '32px', backgroundColor: '#eff6ff', border: '1px solid #bfdbfe', borderRadius: '8px', cursor: 'pointer', fontSize: '14px', display: 'flex', alignItems: 'center', justifyContent: 'center' },
  delBtn:  { width: '32px', height: '32px', backgroundColor: '#fef2f2', border: '1px solid #fecaca', borderRadius: '8px', cursor: 'pointer', fontSize: '14px', display: 'flex', alignItems: 'center', justifyContent: 'center' },
  ...
  bedStats: { display: 'flex', gap: '12px', marginBottom: '12px', flexWrap: 'wrap' },
  bedStatItem: { display: 'flex', alignItems: 'center', gap: '5px' },
  bedDot: () => ({ fontSize: '8px' }),
